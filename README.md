# Get Serial Port Output from Teachable Machine AI by using p5.js Scripts

![_7F7jsR1TNZ](https://user-images.githubusercontent.com/44191076/75604545-bc02e000-5b14-11ea-8cc9-44da27e779db.jpg)

This is for people who want to use Teachable Machine AI on their external devices (like microcontrollers) without any AI knowledge.
...
## sketch.js (Sound Recognition)

```javascript
  // **********

  let portName = 'COM__'; // serial port
  let soundModelURL = 'https://teachablemachine.withgoogle.com/models/______/'; // model URL
...
<html lang="en">
  <head>
    <div>Teachable Machine - Sound Recognition Serial Output</div>
...
In the p5.js editor, click Sketch -> Add file, name it **p5.serialport.js** and paste the following code into it.
